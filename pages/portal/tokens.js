...
You've been invited to complete a MindPrint™ assessment. This short assessment identifies how you're naturally wired to think through and solve problems — it takes about 7-10 minutes to complete.
...
export default function PortalTokens() {
  ...
  return (
    <>
      ...
      <div style={s.page}>
        <PortalNav me={me} onLogout={logout} active="tokens" licenses={dash?.licenses} isIndividual={!!dash?.myAssessment} isTeamAccount={dash?.tier === 'enterprise'} />
        <main style={s.main}>
