      ...
      <div className="shell">
        ...
        <main className="content">
          ...
          <section className="section" id="portal-session-architect">
            ...
            <Card title="Generate Session Materials">Client-side PowerPoint export (via <code>pptxgenjs</code>) built from the same generated agenda: a cover slide, an agenda overview, then a section-divider slide and a full activity-instruction slide (time/energy/materials, numbered steps, facilitator tips, and the "you'll know it worked when" signal) for every block, closing with a wrap-up slide. Styled off the same brand palette, fonts, and WHY/WHAT/HOW character illustrations as the rest of the portal. Suggested openers and "no one in this orientation is in the room" flags carry over from the on-screen agenda onto each divider slide.</Card>
