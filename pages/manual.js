      ...
      <div className="shell">
        ...
        <main className="content">
          ...
          <section className="section" id="admin-accounts">
            ...
            <Card title="Grant profile match (for demos)">Below the manual license picker, in both Invite New Account and Edit Account: pick a MindPrint™ profile and click <strong>+ Add Match</strong> to instantly queue that profile's tertiary-matching Companion license and Resources collection license, instead of hunting for which of the three Companions or five collections corresponds to a given profile. Useful for standing up a sales demo account before anyone has actually completed an assessment. It only adds entries not already in the license list, and doesn't submit on its own, review before saving as usual.</Card>
