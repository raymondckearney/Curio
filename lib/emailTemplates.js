...
<div style="max-width:560px;margin:32px auto">
  ...
  <p style="margin:20px 0 0;color:#94A3B8;font-size:12px;line-height:1.6;text-align:center">Hi {{name}} — this is your weekly MindPrint™ profile tip.<br><a href="{{unsubscribeUrl}}" style="color:#94A3B8;text-decoration:underline">Unsubscribe from these tips</a></p>
</div>
</body></html>`,
  },
];
